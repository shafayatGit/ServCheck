        ...
        <div className="max-w-6xl mx-auto px-4 text-center">
          ...
          <div className="grid gap-8 sm:grid-cols-2 md:grid-cols-3">
            {testimonials.map((user, i) => (
              <div
                key={i}
                className="p-9 px-3 flex flex-col justify-center rounded-xl shadow-md hover:shadow-blue-300 shadow-blue-300  hover:shadow-lg transition duration-300 hover:scale-105"
              >
                <img
                  src={user.avatar}
                  alt={user.name}
